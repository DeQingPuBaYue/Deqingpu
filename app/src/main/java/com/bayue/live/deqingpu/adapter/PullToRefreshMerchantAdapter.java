 ...
 * 修改备注：
 */
public class PullToRefreshMerchantAdapter extends BaseQuickAdapter<MerchantFood.DataBean, BaseViewHolder>{
    List<MerchantFood.DataBean> data = new ArrayList<>();
    Context context;
    public PullToRefreshMerchantAdapter(Context context, List<MerchantFood.DataBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, MerchantFood.DataBean item) {
