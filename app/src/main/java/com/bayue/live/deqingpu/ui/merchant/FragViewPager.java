...
public class FragViewPager extends BaseFragment {

    String TAG = "FragViewPager";
    ...
    public static FragViewPager newInstance(Bundle bundle) {
        FragViewPager viewPagerFragment = new FragViewPager();
...
//        bundle.putString(Constants.ARGS, s);
    ...
    FragItemGoods defaultFrag;
    FragItemGoods valumeFrag;
    FragItemGoods priceFrag;
    FragItemGoods actFrag;
    FragViewPagerAdapter mViewPagerAdapter;
    @Override
    public void init() {
...
//        actBundle.putString("sort", "ASC");
        ...
        mViewPagerAdapter = new FragViewPagerAdapter(getChildFragmentManager(), fragments);
        vpMerchant.setAdapter(mViewPagerAdapter);
...
//        txtMerchantTravel.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null);
    ...
    private void notifyViewPagerDataSetChanged() {
        Tracer.e(TAG, "notifyDataSetChanged()");
        mViewPagerAdapter.notifyDataSetChanged();
    }

    private class FragViewPagerAdapter extends FragmentPagerAdapter{
        private List<LazyLoadFragment> fmList;
        private FragmentManager fm;
        public FragViewPagerAdapter(FragmentManager fm, List<LazyLoadFragment> fmList) {
            super(fm);
            this.fm = fm;
            this.fmList = fmList;
        }
        ...
        public Fragment getItem(int position) {
            pos = position;
            Tracer.e(TAG, "getItem(" + position + ")");
//            Bundle defaultBundle = getBundle();
//            String sort = "ASC";
//            defaultBundle.putString("sort", sort);
//            if (position == 0) {
////                defaultBundle.putString("order", "goods_id");
//                return defaultFrag;
//            } else if (position == 1) {
////                defaultBundle.putString("order", "sales");
//                return valumeFrag;
//            } else if (position == 2) {
////                defaultBundle.putString("order", "shop_price");
//                return priceFrag;
//            } else if (position == 3) {
////                defaultBundle.putString("order", "goods_id");
//                return actFrag;
...
//            return null;
        ...
        public int getItemPosition(Object object) {
            if (object instanceof FragItemGoods) {
                Bundle defaultBundle = getBundle();
                String sort = "ASC";
                switch (pos){
                    case 0:
                ...
                ((FragItemGoods) object).updateArguments(defaultBundle);
            }
