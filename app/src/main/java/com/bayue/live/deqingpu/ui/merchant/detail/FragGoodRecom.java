...
public class FragGoodRecom extends LazyLoadFragment implements SwipeRefreshLayout.OnRefreshListener{

    String TAG = "FragGoodRecom";
    ...
    private void beginGet(final int pages, final int LoadStatus){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                getDataFromNet(API.Merchant.GOODS_AFFILIATE, map, LoadStatus);
            }
        }, 300);
