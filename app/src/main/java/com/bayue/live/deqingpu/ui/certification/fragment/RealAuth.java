    ...
    public void setOnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.linUploadImg:
                View photoView=LayoutInflater.from(getContext()).inflate(R.layout.common_layout,null);
                customHelper=CustomHelper.of(photoView);
...
//                Glide.with().load(new File(images.get(0).getCompressPath()))
//                        .placeholder(R.mipmap.upload_ex).error(R.mipmap.ic_launcher).into(imgAuthPhoto);
//            }
//        });
    }
