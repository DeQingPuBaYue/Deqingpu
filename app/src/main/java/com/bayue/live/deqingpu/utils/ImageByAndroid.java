...
public class ImageByAndroid {
    ...
    public static void startPhotoZoom(Uri uri, Activity context, Uri cutImgUri, boolean isCrop) {
        ...
        context.startActivityForResult(intent, CertificationActivity.PHOTO_REQUEST_CUT);
    }
...
//            Log.e("[Android]", "目录为：" + uri);
     ...
     * Bitmap转为图片保存
     * */
    public static final String avatorpath = Environment.getExternalStorageDirectory() + "/deqingpu/";
