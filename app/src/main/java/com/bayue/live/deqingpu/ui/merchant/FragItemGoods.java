...
public class FragItemGoods extends LazyLoadFragment implements SwipeRefreshLayout.OnRefreshListener{

    String TAG = "FragItemGoods";
...
//    private Novate novate;
    ...
    public static FragItemGoods newInstance(Bundle bundle) {
        FragItemGoods viewPagerFragment = new FragItemGoods();
    ...
    public void updateArguments(Bundle bundle) {
        getBunlde(bundle);
        Tracer.e(TAG, "update:" + sort +" order:"+ order);
        beginGet(1, loadRefresh);
    }
    private void getBunlde(Bundle bundle){
        typeDefalut = bundle.getInt(Constants.ARGS);
        cat_id =bundle.getInt("cat_id");
        storeId = bundle.getInt("store");
